...
let router = new Router({
    ...
    routes: [
        ...
        },
        {
            path: "/admin/tasks",
            name: "tasks",
            component: () => import("./views/admin/pages/tasks/index.vue"),
            meta: {
                requiresAuth: true,
                layout: AdminLayout
            }
        },
        {
            ...
            name: "tasks.create",
            component: () => import("./views/admin/pages/tasks/create.vue"),
            meta: {
                requiresAuth: true,
                layout: AdminLayout
            }
        },
        {
            path: "/admin/tasks/:id",
            name: "tasks.edit",
            component: () => import("./views/admin/pages/tasks/edit.vue"),
            meta: {
                requiresAuth: true,
                layout: AdminLayout
            }
